...
tags: [WeeklyReview, Chisel, BNN, codesign, HPML, HPC, ML4HPC]
excerpt: This review contains the usage of general data type in Chisel, the basic architecture of NN and the introductions of BNN and the BitFlow algorithm. Also, one paper related to FPGA and DNN co-design and some materials related to HPC+ML. The papers are 1) FPGA/DNN Co-Design" An Efficient Design Methodology for IoT Intelligence on the Edge; 2) BitFlow" Exploiting Vector Parallelism for Binary Neural Networks on CPU
redirect_from:
  - /2020/02/09/
---
