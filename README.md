...
1. [2019/12/16-22](#20191216-22)
	1. [Functional Programming Principles in Scala](#functional-programming-principles-in-scala)
		1. [Week1](#week1)
			1. [Classes, Traits, Objects and Packages](#classes-traits-objects-and-packages)
				1. [Classes](#classes)
				1. [Traits](#traits)
				1. [Objects](#objects)
				1. [Packages](#packages)
				1. [Source Files](#source-files)
			1. [Coursera Elements of Programming](#coursera-elements-of-programming)
			1. [Blocks](#blocks)
		...
		1. [Week2](#week2)
			...
			1. [Require and Assert](#require-and-assert)
...
1. [2019/12/09-15](#20191209-15)
	1. [Git Command](#git-command)
		...
		1. [Build a git project](#build-a-git-project)
			1. [Create one new project](#create-one-new-project)
			1. [Config](#config)
			1. [add/remove files](#addremove-files)
			1. [Commit codes from `Index` to `Repository`](#commit-codes-from-index-to-repository)
			1. [Push codes from `Repository` to `Remote`](#push-codes-from-repository-to-remote)
			1. [Show Information](#show-information)
	...
	1. [Chipyard](#chipyard)
		1. [`SHA3`](#sha3)
			1. [`SHA3`-Chisel](#sha3-chisel)
				1. [`sha3.scala`](#sha3scala)
				1. [`ctrl.scala`](#ctrlscala)
			1. [`SHA3`-test](#sha3-test)
		1. [`Hwacha`](#hwacha)
			1. [`Hwacha`-Chisel](#hwacha-chisel)
	1. [`RoCC` and extension instruction](#rocc-and-extension-instruction)
		...
		1. [extension instruction with `RoCC`](#extension-instruction-with-rocc)
			1. [`RoCC`-Chisel](#rocc-chisel)
			1. [Instruction test with C](#instruction-test-with-c)
	...
	1. [Computer Architecture](#computer-architecture)
		...
		1. [Page Table Walk](#page-table-walk)
			1. [PTW Introduction](#ptw-introduction)
		1. [Translation Lookaside Buffer](#translation-lookaside-buffer)
			1. [TLB Introduction](#tlb-introduction)
			1. [TLB passthrough](#tlb-passthrough)
